 ...
 * @date Mar 2017
 */
public class EvaluationPopularityApproach {
  ...
  int[] anime = {
    ...
    public void runEvaluation() throws IOException {
        ...
        System.out.println("\nPopularity - overall time:" + (System.currentTimeMillis()- startTime) + "msec" );
    }
     ...
     public void evaluationPerUser(int userId, int k_folds) throws IOException {
        try {
            ...
            for (int f = 1; f < k_folds + 1; f++) {
                ...
                B_RunningMode.runningMode = 2; //recommendations based on popularity
